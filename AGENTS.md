...
Current state (2026-05-01): Working placeholder is activity-aware and image upload is now wired end-to-end for vision-capable models (with frontend capability flag + backend upload references); see `BLUEPRINT.md` §8 (**Status Snapshot**).
