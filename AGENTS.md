...
Current state (2026-05-03): Modular backend API is live with passing tests; fixed SDK metadata/ordering/delta streaming, smoothed SSE text output, and now announces a pending assistant message immediately so Working transitions like OpenChamber.
