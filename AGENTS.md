...
Current state (2026-05-03): Modular backend API is live with passing tests; fixed startup/sidebar regressions, reload compatibility, and theme switching now ignores VSCode theme lock unless runtime is truly vscode.
