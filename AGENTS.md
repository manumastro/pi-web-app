...
Current state (2026-05-02): Modular backend API is live with passing tests; fixed bootstrap/model/send regressions and `/api/agent` now returns a default agent to stop frontend retry storms.
