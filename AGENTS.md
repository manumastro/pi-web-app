...
Current state (2026-05-03): Modular backend API is live with passing tests; fixed startup/sidebar regressions, added /api/config/reload compatibility, and hardened theme persistence against dark/light reversion on reload.
