...
Current state (2026-05-02): Modular backend API is live with passing tests; fixed bootstrap/model/send regressions, `/api/agent` retry storm, message-ID reconciliation, isolated assistant stream IDs, and added client-error telemetry (`/api/client-error` + ChatErrorBoundary component stack reporting) to trace remaining React update-depth loops.
