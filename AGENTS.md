...
Current state (2026-04-21): See `BLUEPRINT.md` (sections **15.0 Status Snapshot**, **5.1 Feature Matrix**, and phase checklists **15.1–15.6**) as the single up-to-date source of project status; latest significant change includes OpenChamber-style streaming/history parity upgrades: virtualized static history, dedicated streaming tail path, assistant status heuristics, content-settling hooks, and expanded markdown parity (math, Mermaid, richer code blocks, copy/download, explicit variants).
