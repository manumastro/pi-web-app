...
Current state (2026-05-03): Modular backend API is live with passing tests; fixed startup/sidebar regressions and theme/appearance persistence now survives reload via immediate theme settings flush.
