...
- Verification after working-state fidelity hardening: `npm -ws --if-present test -- --run` (100 backend tests, 87 frontend tests), `npm -ws --if-present run lint`, and `npm -ws --if-present run build` are green.
