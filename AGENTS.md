...
Current state (2026-05-02): Modular backend API is live with passing tests; fixed bootstrap/model/send regressions, SDK message/model metadata, sortable user→assistant IDs, and now streams text/reasoning as OpenCode deltas instead of replacing parts with the last chunk.
