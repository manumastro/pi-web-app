...
Current state (2026-05-03): Modular backend API is live with passing tests; fixed stream/tool regressions and added sidebar recovery that repopulates sessions from per-directory list when startup snapshots come up empty.
