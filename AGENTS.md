...
Current state (2026-05-03): Modular backend API is live with passing tests; fixed SDK metadata/ordering/delta streaming, smoothed SSE text output, pending assistant turns, animated Working placeholder, and persisted/live tool part fidelity.
