...
Current state (2026-05-04): Fixed assistant text duplication by detecting snapshot-correction text events in orchestrator and emitting `message.part.updated` (replacement) instead of deltas (append). Frontend rebuilt and deployed.
